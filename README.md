...
| Package | Description |
|---------|-------------|
| [`@linklabjs/core`](./packages/core) | Graph engine, fluent API, Fastify plugin |
| [`@linklabjs/cli`](./packages/cli) | CLI — build, repl, server, test, train |
| [`@linklabjs/telemetry`](./packages/telemetry) | Observability pipeline, metrics, calibration |
